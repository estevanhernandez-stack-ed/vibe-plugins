...
| **Vibe Glow** | [`vibe-glow`](https://github.com/estevanhernandez-stack-ed/vibe-glow) | [![](https://img.shields.io/github/v/tag/estevanhernandez-stack-ed/vibe-glow?label=&color=17d4fa)](https://github.com/estevanhernandez-stack-ed/vibe-glow/tags) | Repeatable multi-stage UI beautification campaigns — app-wide or scoped to one area with a goal in your own words. Concierge entry: one call runs the whole campaign, consent-gated stage by stage. Four gated stages (identity, audit with five Opus lenses plus a skeptic pass, findings-driven waves re-reviewed until clean, reveal or goal-check close-out). Evidence adapters for Windows-native apps (WinUI/WPF/Win32 — UIA-driven capture with route maps, UIA tree dumps, pixel sampling) and web (Playwright). |
